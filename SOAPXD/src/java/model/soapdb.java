...
public class soapdb {
    ...
    public static void main (String []args) throws FileNotFoundException, JSONException {
        JsonReader reader = Json.createReader(new FileReader("C:\\Users\\DEMON SH4DOW\\Documents\\NetBeansProjects\\data.txt"));
        ...
        for(int i = 0; i < arr.length(); i++) {
            ...
            Table117 cov = new Table117(yearnum, weeknum, new_case, total_case, new_case_excludeabroad, total_case_excludeabroad,
