...
public class Coviddata {
    ...
    public String toString() {
        return "Coviddata{" + "caseForeign=" + caseForeign + ", caseNewDiff=" + caseNewDiff + ", caseNewPrev=" + caseNewPrev + ", casePrison=" + casePrison + ", caseWalkin=" + caseWalkin + ", deathNewDiff=" + deathNewDiff + ", deathNewPrev=" + deathNewPrev + ", newCase=" + newCase + ", newCaseExcludeabroad=" + newCaseExcludeabroad + ", newDeath=" + newDeath + ", newRecovered=" + newRecovered + ", totalCase=" + totalCase + ", totalCaseExcludeabroad=" + totalCaseExcludeabroad + ", totalDeath=" + totalDeath + ", totalRecovered=" + totalRecovered + ", updateDate=" + updateDate + ", weeknum=" + weeknum + ", yearnum=" + yearnum + '}';
    }
